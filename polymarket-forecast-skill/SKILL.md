---
name: "polymarket-forecast-skill"
...
```bash
python scripts/get_weather.py current "<location>"          # Current weather
python scripts/get_weather.py forecast "<location>" <days>  # Multi-day forecast (1-5 days)
```
...
**Important**: The script is located at `scripts/get_weather.py`.
...
2. Call: `python scripts/get_weather.py forecast Boulder 2`
...
2. Call: `python scripts/get_weather.py activity skiing Vail 5`
...
2. Call: `python scripts/get_weather.py forecast Aspen 2` (for this weekend)
