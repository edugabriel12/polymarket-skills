...
# The shared `calibration` module lives in the original skill's scripts/ dir and is reused by
# every sport's calibration report, so this path stays on sys.path even though MLB is gone.
_SHARED_SCRIPTS = os.path.normpath(os.path.join(_BACKEND_DIR, "..", "..", "scripts"))
